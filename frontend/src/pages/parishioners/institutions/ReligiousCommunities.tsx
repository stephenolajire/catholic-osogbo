...
const ReligiousCommunities = () => {
  ...
  const { data: category, isLoading } = useInstitutionCategory("religious");
  const displayCategory =
    category ||
    DEFAULT_INSTITUTION_CATEGORIES.find((c) => c.categoryKey === "religious");
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <InstitutionHero
        title={selectedSubcategory?.name || "Religious Communities"}
        description={
          selectedSubcategory?.description ||
          "Living out the Gospel in community. Our religious communities dedicate their lives to prayer, contemplation, and service, embodying the charism of their founders in witness to faith."
        }
        totalInstitutions={
          ...
          {isLoading ? (
            ...
            <div>
              ...
              <p className="text-amber-700/70 mb-12">
                Choose a community type to view available communities
              </p>
