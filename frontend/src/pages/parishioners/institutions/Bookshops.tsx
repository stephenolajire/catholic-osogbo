...
const Bookshops = () => {
  ...
  const { data: category, isLoading } = useInstitutionCategory("bookshop");
  const displayCategory =
    category ||
    DEFAULT_INSTITUTION_CATEGORIES.find((c) => c.categoryKey === "bookshop");
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <InstitutionHero
        title={selectedSubcategory?.name || "Bookshops"}
        description={
          selectedSubcategory?.description ||
          "Resources for spiritual growth and knowledge. Our bookshops provide religious texts, liturgical materials, and educational resources to support the spiritual journey of our community."
        }
        totalInstitutions={
          ...
          {isLoading ? (
            ...
            <div>
              ...
              <p className="text-amber-700/70 mb-12">
                Choose a bookshop type to view available locations
              </p>
