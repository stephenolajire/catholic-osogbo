...
const Education = () => {
  ...
  const { data: category, isLoading } = useInstitutionCategory("education");
  const displayCategory =
    category ||
    DEFAULT_INSTITUTION_CATEGORIES.find((c) => c.categoryKey === "education");
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <InstitutionHero
        title={selectedSubcategory?.name || "Educational Institutions"}
        description={
          selectedSubcategory?.description ||
          "Quality education rooted in Christian values. Our schools provide comprehensive learning environments that nurture academic excellence, moral development, and spiritual growth for students of all ages."
        }
        totalInstitutions={
